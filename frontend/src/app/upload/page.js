          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-100 p-8 shadow-sm relative">
              ...
              <button
                ...
                className={`w-full mt-6 py-4 rounded-xl text-sm font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-3 ${file && !loading
