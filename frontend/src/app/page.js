    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-[#FAFAFA] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]">
        <section className="pt-20 pb-20 px-6 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-5xl md:text-6xl font-serif italic text-[#2F5233]">
            Documents & Notices
          </h2>
        ...
        <div className="relative h-64 w-full max-w-3xl mx-auto overflow-hidden opacity-30 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] border border-slate-300 rounded-full"></div>
          <div className="absolute top-12 left-1/2 -translate-x-1/2 w-[500px] h-[500px] border border-slate-300 rounded-full"></div>
          <div className="absolute top-24 left-1/2 -translate-x-1/2 w-[400px] h-[400px] border border-slate-300 rounded-full"></div>
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-[10px] font-bold tracking-widest text-[#A1A1AA]">PRIVATE & SECURE</div>
        </div>
